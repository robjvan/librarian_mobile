// Uri _weatherApiUrl = Uri.parse('http://api.yourlibrarian.ca/');
import 'package:get/get.dart';

Uri _librarianApiUrl = Uri.parse('http://10.0.0.79:3000'); // workstation
// Uri _recipesApiUrl = Uri.parse('http://10.0.0.242:3000'); // tablet

class Config {
  final Uri _apiUrl = _librarianApiUrl;
